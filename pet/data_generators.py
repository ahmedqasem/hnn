...
def get_anchor_gt2(all_img_data, class_count, C, img_length_calc_function, backend, mode='train'):
...
def get_anchor_gt_new(all_img_data, C, img_length_calc_function, mode='train'):
    """ Yield the ground-truth anchors as Y (labels)
