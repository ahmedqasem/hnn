...
from pet.roi_pooling_conv import RoiPoolingConv
...
#
# # vgg nn -> returns vgg architecture
# shared_layers = nn_base(img_input, trainable=True)
# # rpn -> returns list of 3 layers
# rpn = rpn_layer(shared_layers, num_anchors)
# # classifier network ->
# classifier = classifier_layer(shared_layers, roi_input, 4, nb_classes=2)
#
