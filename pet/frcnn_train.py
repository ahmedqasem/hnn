...
from pet import config, data_generators
from pet import losses as losses
import pet.roi_helpers as roi_helpers
from keras.utils import generic_utils
from keras.callbacks import TensorBoard


# tensorboard log write function
...
if options.parser == 'pascal_voc':
    from pet.pascal_voc_parser import get_data
...
if options.network == 'vgg':
    C.network = 'vgg'
    from pet import vgg as nn
elif options.network == 'resnet50':
    from pet import resnet as nn
    C.network = 'resnet50'
elif options.network == 'xception':
    from pet import xception as nn
    C.network = 'xception'
elif options.network == 'inception_resnet_v2':
    from pet import inception_resnet_v2 as nn
...
# parser Get image, class, and class mapping information from
...
# # split image list into training and testing (used when we need to split the dataset)
# train_imgs = [s for s in all_imgs if s['imageset'] == 'trainval']
# test_imgs = [s for s in all_imgs if s['imageset'] == 'test']
# print('Num train samples {}'.format(len(train_imgs)))
# print('Num test samples {}'.format(len(test_imgs)))
# # print('Num test samples {}'.format(len(all_imgs)))
#
# # groundtruth anchor get data
...
# data_gen_train = data_generators.get_anchor_gt2(all_imgs, classes_count, C, nn.get_img_output_length, K.image_dim_ordering(), mode='train')
data_gen_train = data_generators.get_anchor_gt_new(all_imgs, C, nn.get_img_output_length, mode='train')
print('Num train samples {}'.format(len(all_imgs)))
